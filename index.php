...
<head>
    ...
    <title>Halaman Home Hendrik</title>
            ...
            <div class="category-container">
                ...
                ?>
                    <div class="category-item" style="margin-top: 20px; margin-bottom: 20px;">
                        ...
                        <img src="logo.jpeg" alt="<?php echo $data['namaalbum'] ?>" class="category-icon">
                ...
                ?>
                        <p style="text-align: center;">Belum ada Album</p>
                <?php } ?>
            </div>
        </div>
    </div>
